...
interface MainRepository {
    ...
    suspend fun insertPlayerToDB(player: PlayerData): Response<Boolean>

    suspend fun deleteAllPlayersInDB(): Response<Boolean>

    suspend fun getQuestionsFromDB(level: Int): Response<List<Question>>
